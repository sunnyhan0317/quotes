  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '2.5rem 1.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.2rem', marginBottom: '1.2rem' }}>
        ...
        {/* AI vs 用戶 */}
        <div style={card()}>
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.6rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: '1rem' }}>語錄來源偏好</div>
          <BarCompare
            labelA="用戶投稿" valueA={data.preferences.aiVsUser.user}
            labelB="AI 生成" valueB={data.preferences.aiVsUser.ai}
            colorA="#6abf80" colorB="#8aaddf"
          />
          <div style={{ fontFamily: "'Noto Serif TC', serif", fontSize: '0.78rem', color: 'var(--text-dim)', marginTop: '0.8rem' }}>
            {data.preferences.aiVsUser.user > data.preferences.aiVsUser.ai
              ? '你更偏愛人類書寫的溫度'
              : data.preferences.aiVsUser.ai > data.preferences.aiVsUser.user
                ? '你欣賞 AI 創作的精準'
                : '你對兩者都敞開懷抱'}
          </div>
        </div>
        ...
        <div style={card()}>
          ...
          <div style={{ fontFamily: "'Noto Serif TC', serif", fontSize: '1.8rem', color: 'var(--amber)', marginBottom: '0.4rem' }}>
          ...
          <div style={{ fontFamily: "'Noto Serif TC', serif", fontSize: '0.78rem', color: 'var(--text-dim)', marginTop: '0.6rem' }}>
